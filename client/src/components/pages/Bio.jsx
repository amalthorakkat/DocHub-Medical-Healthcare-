      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            <div className="flex flex-col items-center gap-6">
              {/* Profile Picture */}
              <div className="relative group" role="region" aria-label="Profile picture editor">
                <div className="relative w-60 h-60 sm:w-70 sm:h-70">
                  {hasDp ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center rounded-full border-4 border-gray-200 shadow-xl bg-gradient-to-br from-gray-100 to-gray-200 group-hover:shadow-orange-200 transition-all duration-300">
                      <User size={80} className="text-gray-400" aria-hidden="true" />
                    </div>
                  )}
                  <div className="absolute bottom-3 right-3 flex gap-2">
                    <label className="cursor-pointer bg-[#F6981F] text-white p-3 rounded-full shadow-lg hover:bg-[#e8860b] hover:scale-110 transition-all duration-200">
          ...
          {/* Total Bookings Card */}
          <div className="bg-gradient-to-br flex items-center justify-center  from-[#F6981F] to-[#e8860b] rounded-2xl shadow-xl p-8 text-white hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
            <div className="text-center">
              <div className="bg-white/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                <Calendar className="w-10 h-10 text-white" />
              </div>
              ...
              {loading ? (
                ...
                <p className="text-7xl font-bold mb-2">{confirmedAppointmentsCount}</p>
              )}
              <p className="text-white/80 text-lg">Confirmed Appointments</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
              {confirmedAppointments.slice(0, 4).map((appointment, index) => (
                <div
                  ...
                  role="article"
                  aria-label={`Appointment with Dr. ${appointment.doctorId?.name || "Unknown Doctor"}`}
                >
                  <div className="flex items-center gap-4">
                    <div className="relative flex-shrink-0">
                      <img
                        ...
                        alt={`Dr. ${appointment.doctorId?.name || "Unknown Doctor"}`}
                        onError={(e) => {
                          console.error("Image load error for appointment:", {
                            appointmentId: appointment._id,
                            doctorId: appointment.doctorId?._id,
                      ...
                      />
                      <div className="absolute -top-1 -right-1 bg-green-500 rounded-full p-1 sm:p-1.5 shadow-lg">
                        <CheckCircle className="w-3 h-3 sm:w-3 sm:h-3 text-white" aria-hidden="true" />
                      </div>
                    </div>
                    <div className="flex-grow space-y-2 sm:space-y-3">
                      <div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600">
                        <div className="flex items-center gap-1.5 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
                          <Calendar className="w-3 sm:w-4 h-3 sm:h-4 text-[#F6981F]" aria-hidden="true" />
                          <span className="font-medium">{formatDate(appointment.date)}</span>
                        </div>
                        <div className="flex items-center gap-1.5 sm:gap-2 bg-gray-100 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
                          <Clock className="w-3 sm:w-4 h-3 sm:h-4 text-[#F6981F]" aria-hidden="true" />
