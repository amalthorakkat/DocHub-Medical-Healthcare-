...
//   const [selectedSpecialty, setSelectedSpecialty] = useState(""); // Added state for specialty filter
//   const [selectedDate, setSelectedDate] = useState(""); // Added state for date filter
//   const [doctorSuggestions, setDoctorSuggestions] = useState([]); // Added state for doctor suggestions
...
//   // Function to handle doctor search input
//   const handleSearchChange = (e) => {
//     const value = e.target.value;
//     setSearchTerm(value);

//     // Generate doctor suggestions based on search term
//     if (value.trim()) {
...
//   // Function to get unique specialties for the filter
...
//   // Function to get filtered appointments based on search and filters
