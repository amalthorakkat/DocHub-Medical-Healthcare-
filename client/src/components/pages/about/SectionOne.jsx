...
// const SectionOne = () => {
//   return (
//     <div className="flex px-[10px] lg:px-[200px] items-center justify-center gap-[100px] h-[100vh] bg-[conic-gradient(at_center,_#5F6FFF,_#7A85FF,_#A3A9FF,_#FFFFFF,_#5F6FFF)] " >
//       <div className="w-190">
//         <h1 className="flex items-center text-[100px] gap-8 ">
//           This is DocHub
//         </h1>
...
//       {/* image */}
//       <div>
//             <img className="h-[500px]" src={GroupImage} alt="" />
//       </div>
//     </div>
//   );
// };
