...
const Header = () => {
  ...
  const adminButtonClasses = `bg-white border border-black text-black py-2 px-4 text-[13px] rounded-2xl cursor-pointer hover:bg-gray-100 hover:scale-105 active:scale-95 transition-all duration-300`;
  const doctorButtonClasses = `bg-white border border-black text-black py-2 px-4 text-[13px] rounded-2xl cursor-pointer hover:bg-gray-100 hover:scale-105 active:scale-95 transition-all duration-300`;
        ...
        <div className="flex items-center gap-4">
          {user ? (
            <>
              ...
              {user.role === "doctor" && (
                <Link to="/doctor-dashboard" className={doctorButtonClasses}>
                  Doctor Panel
                </Link>
              )}
            </>
              ...
              <>
                ...
                {user.role === "doctor" && (
                  <li className="rounded-lg hover:bg-gray-200/50 transition-all duration-200">
                    <Link
                      to="/doctor-dashboard"
                      className={`${doctorButtonClasses} block w-full text-center px-4 py-2`}
                      onClick={() => setIsOpen(false)}
                    >
                      Doctor Panel
                    </Link>
