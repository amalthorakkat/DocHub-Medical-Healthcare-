...
//                   className="cursor-pointer border w-[200px] h-[280px] rounded-lg shadow-sm overflow-hidden transform transition duration-300 hover:-translate-y-2 hover:shadow-lg hover:scale-105 active:scale-95 active:shadow-inner"
//                 >
              ...
              doctors.slice(0, 10).map((doctor) => (
                ...
                >
                  ...
                  <div className="text-center p-2 sm:p-3">
                    <h1 className="text-green-500 text-xs sm:text-[10px]">Available</h1>
                    <h1 className="font-medium text-sm sm:text-base">{doctor.name}</h1>
                    <p className="text-[#6c6c6c] text-xs sm:text-[13px]">
                      {doctor.specialty || "N/A"}
                    </p>
                  </div>
                </div>
